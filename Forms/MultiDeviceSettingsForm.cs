...
namespace TestTool
{
    ...
    /// </summary>
    public partial class MultiDeviceSettingsForm : Form
    {
        ...
        {
            this.Text = "串口设置";
            this.Size = new Size(520, 380);  // 增加宽度
            this.FormBorderStyle = FormBorderStyle.Sizable;
            this.MaximizeBox = false;
            this.MinimizeBox = false;
            this.MinimumSize = new Size(520, 380);  // 增加最小宽度
            ...
            foreach (DeviceType deviceType in Enum.GetValues<DeviceType>())
            {
                ...
                panel.Size = new Size(485, panelHeight);  // 增加面板宽度
            ...
            {
                Text = "一键解锁",
                Location = new Point(400, currentY + 10),  // 调整位置
                Size = new Size(90, 30),
    ...
    public class DeviceSettingsPanel : Panel
    {
        ...
        public DeviceSettingsPanel(DeviceType deviceType, DeviceConfig config, MainForm? mainForm, Func<DeviceType, HashSet<string>>? getLockedPorts = null)
        {
            ...
            this.Size = new Size(485, 60);  // 增加面板宽度
        ...
        private void OnMonitorStateChanged(object? sender, MonitorStateChangedEventArgs e)
        {
            if (e.DeviceType == _deviceType)
            {
                ...
                if (InvokeRequired)
                {
                    try
                    {
                        BeginInvoke(new Action(() => UpdateMonitorButtonState(e.IsOpen)));
                    }
                ...
                {
                    UpdateMonitorButtonState(e.IsOpen);
                }
            }
        }
        ...
        public bool ValidateSettings()
        {
            ...
            if (!int.TryParse(_cmbBaudRate.Text, out var baudRate) || baudRate <= 0)
            {
                MessageBox.Show($"请为 {_deviceType} 输入有效的波特率", "提示", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return false;
            }
